...
<div class="header">
    <div class="header-div">
      ...
      <div class="header-options">
          <a class="home" href="http://localhost/N/Home%20page.html">HOME</a>
          <!-- <a class="login" href="#">LOGIN</a> -->
          <!-- <a class="register" href="#">REGISTER</a> -->
          <a class="contact-us" href="http://localhost/N/contactus.html">CONTACT US</a>
          <a class="calories" href="http://localhost/N/login.php">CALORIES</a>
            ...
            <div class="forscroll">
                ...
                if($info) {
                    while ($row2 = mysqli_fetch_assoc($info)) {
                        $column1Value = $row2['meal']; // Replace 'column1' with your actual column name
                        $column2Value = $row2['calories']; // Replace 'column2' with your actual column name
                        
                        // Displaying dynamic content inside the loop
  ...
  <div class="footer-container">
    <div class=footer-links>
      <a id="about-us" href="http://localhost/N/Home%20page.html">HOME</a>
      <a id="features" href="http://localhost/N/login.php">CALORIES</a>
      <!-- <a id="sdgs" href="#">REGISTER</a> -->
      <a id="contact-us" href="http://localhost/N/contactus.html">CONTACT US</a>
